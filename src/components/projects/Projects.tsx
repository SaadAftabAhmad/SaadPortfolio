    ...
    <div id="projects" className="bg-gradient-to-br from-[#261c33] via-[#344ab4] to-[#b65881] px-10 max-[450px]:px-5 pb-10">
      ...
      <div ref={ref} className="mt-10 flex flex-col gap-8">
        <motion.div
          ...
          transition={{ type: "spring", stiffness: 50, duration: 1000, delay: 0.3 }}
        >
          <div className="w-full flex justify-center max-[750px]:justify-start items-end gap-10 max-[800px]:gap-3 pr-[200px] max-[850px]:pr-[300px] max-[750px]:pr-0">
            <div className="relative">
              <Link href="https://staging.dashboard.harazdentalgroup.com">
              <Image src={project1} className="w-[200px] max-[450px]:w-[150px] h-[200px] max-[450px]:h-[160px] object-cover rounded-[20px]" alt="project" />
              </Link>
              <p className="absolute top-5 right-[-50px] text-[#000000] font-[500] text-[20px] text-shadow">Project 1</p>
            </div>
        ...
        >
          <div className="w-full flex justify-center max-[750px]:justify-end items-start gap-10 max-[800px]:gap-3 pl-[200px] max-[850px]:pl-[230px] max-[750px]:pl-0">
            ...
            <div className="relative">
              ...
              <p className="absolute bottom-10 left-[-50px] text-[#000000] font-[500] text-[20px] text-shadow">Project 1</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="w-full flex justify-center max-[750px]:justify-start items-end gap-10 max-[800px]:gap-3 pr-[200px] max-[850px]:pr-[300px] max-[750px]:pr-0">
            <div className="relative">
              ...
              <p className="absolute top-4 right-[-50px] text-[#000000] font-[500] text-[20px] text-shadow">Project 1</p>
            </div>
        ...
        >
          <div className="w-full flex justify-center max-[750px]:justify-end items-end gap-10 max-[800px]:gap-3 pl-[200px] max-[850px]:pl-[270px] max-[750px]:pl-0">
            <div className="flex flex-col gap-5 max-[800px]:gap-3 pb-3">
              <div className="flex gap-5 max-[800px]:gap-3">
                <div className="w-2 h-2 bg-[#22186c] rounded-full" />
                <div className="w-2 h-2 bg-[#22186c] rounded-full" />
            ...
            <div className="relative">
              ...
              <p className="absolute top-3 left-[-50px] text-[#000000] font-[500] text-[20px] text-shadow">Project 1</p>
            </div>
          </div>
        </motion.div>
      </div>

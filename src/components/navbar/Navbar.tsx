...
const Navbar = () => {
  return (
    <div className="fixed top-4 right-10 bg-gradient-to-tr from-[#1a1323]/40 to-[#1c366a]/40 flex flex-col gap-10 py-10 px-5 rounded-[20px]">
      {/* <div className=""> */}
...
{/* <p className="text-[35px] font-[500] text-white">SAAD</p>

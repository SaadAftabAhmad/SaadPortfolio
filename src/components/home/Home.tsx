...
import developer from "../../png/developer img.png";
  ...
  return (
    <div className="w-full h-[100vh] flex">
      <div id="home" className="w-[100%] px-10 max-[800px]:px-5 flex justify-between items-center max-[640px]:items-start max-[640px]:flex-col">
        ...
        <div className="absolute right-[150px] max-[920px]:right-[90px] max-[700px]:right-[60px] max-[330px]:right-auto max-[640px]:top-[200px]">
          <div className="w-[500px] max-[1100px]:w-[400px] max-md:w-[300px] max-[375px]:w-[250px] h-[500px] max-[1100px]:h-[400px] max-md:h-[300px] max-[375px]:h-[250px] flex justify-center items-center relative">
            <div className="absolute w-full h-full border-l-[3px] border-red-400 border-r-[3px] border-r-[#29254d] rounded-full animate-rotate">
              <div className="w-[70px] h-[70px] bg-gradient-to-bl from-[#93cedd] to-[#f85dfb] fixed right-[50px] max-[1100px]:right-[10px] max-md:right-[5px] top-3" style={{ clipPath: "ellipse(44% 38% at 50% 50%)", }} />
              <div className="w-[70px] h-[70px] bg-gradient-to-bl from-[#93cedd] to-[#f85dfb] fixed left-5 max-md:left-0 bottom-10 max-[1100px]:bottom-6 max-md:bottom-0" style={{ clipPath: "ellipse(48% 45% at 50% 50%)", }} />
              <div className="w-[70px] h-[70px] bg-gradient-to-bl from-[#93cedd] to-[#f85dfb] fixed left-10 max-md:left-0 top-14 max-[1100px]:top-0" style={{ clipPath: "ellipse(48% 45% at 50% 50%)", }} />
              <div className="w-[70px] h-[70px] bg-gradient-to-tl from-[#93cedd] to-[#f85dfb] fixed right-0 max-[1100px]:right-4 max-md:right-0 bottom-10 max-[1100px]:bottom-3 max-md:bottom-0" style={{ clipPath: "ellipse(48% 45% at 50% 50%)", }} />
            </div>
